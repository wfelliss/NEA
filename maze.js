...
function PrimsAlgorithm(maze,size)
{
...
function Frontier(maze, currentCell)
{
...
function MoveSquare(numSelected, maze, currentCell)
{
    if (numSelected === 0)
    {
