...
function setup() {
  ...
  let bheight = 50;
  play = new Button(
    screenSize / 2 - bwidth / 2,
    screenSize / 3 - bheight,
    bwidth,
    bheight,
    "play"
  );
...
function draw() {
  if (gamestatus === "game") {
    ...
    text(
      mazeSliderValue,
      mazeSlider.x + 10 + mazeSlider.width,
      screenSize / 3 + 15
    );
    ...
    text(
      enemySliderValue,
      enemySlider.x + 10 + enemySlider.width,
      screenSize / 2 + 15
    );
